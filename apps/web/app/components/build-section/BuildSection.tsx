    ...
    <section>
      ...
      <ul className="py-10 px-32 grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
        <GridItem
          ...
          icon={
            <Discord className="h-4 w-4 text-black dark:text-neutral-400" />
          }
        ...
        <GridItem
          ...
          icon={
            <LinkedIn className="h-4 w-4 text-black dark:text-neutral-400" />
          }
        ...
        <GridItem
          ...
          icon={
            <TwitterX className="h-4 w-4 text-black dark:text-neutral-400" />
          }
